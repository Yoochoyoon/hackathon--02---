...
> 2026 해커톤 (13:30–16:40, 실제 구현 시간 약 130분) 팀 02 결과물
...
| **월별 통계 차트** | 월별 활동 횟수 막대그래프 |
| **반응형 레이아웃** | 600px 아래에서 세로 1열로 전환 |
...
| 이름 | GitHub | 맡은 곳 |
|---|---|---|
| 유초윤 | [@Yoochoyoon](https://github.com/Yoochoyoon) | `app.js` — 등록·조회·삭제·수정·기간 필터·입력값 검증 |
| 신찬영 | [@scyscu153-byte](https://github.com/scyscu153-byte) | `style.css`, `features.js` — 검색·월별 통계·반응형 |
